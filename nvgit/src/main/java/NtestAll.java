...
public class NtestAll {
    ...
    public static String[] getGithubCredentials() {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String[] credentials = getGithubCredentials();
        ...
        if (buttonInput == 1) {
            ...
            if (git != null) {
                System.out.println("Do you want to push the changes? (yes/no)");
                input.nextLine(); // Consume newline left from previous nextInt()
                String pushInput = input.nextLine();
                if (pushInput.equalsIgnoreCase("yes")) {
                    addAllFiles(git);
